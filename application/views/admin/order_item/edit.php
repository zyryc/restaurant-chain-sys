			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="order_id" class="form-control">
								...
								{
									$selected = ($order['id'] == $order_item['order_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="food_id" class="form-control">
								...
								{
									$selected = ($food['food_id'] == $order_item['food_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="quantity" value="<?php echo ($this->input->post('quantity') ? $this->input->post('quantity') : $order_item['quantity']); ?>" class="form-control" id="quantity" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="sub_total" class="control-label">Sub Total</label>
						<div class="form-group">
							<input type="text" name="sub_total" value="<?php echo ($this->input->post('sub_total') ? $this->input->post('sub_total') : $order_item['sub_total']); ?>" class="form-control" id="sub_total" />
						</div>
					</div>
				</div>
			</div>
