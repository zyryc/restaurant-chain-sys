          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="menuId" class="form-control">
								...
								{
									$selected = ($menu_list['menu_id'] == $this->input->post('menuId')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="food_name" value="<?php echo $this->input->post('food_name'); ?>" class="form-control" id="food_name" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="food_image" value="<?php echo $this->input->post('food_image'); ?>" class="form-control" id="food_image" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="was_price" class="control-label">Was Price</label>
						<div class="form-group">
							<input type="text" name="was_price" value="<?php echo $this->input->post('was_price'); ?>" class="form-control" id="was_price" />
						</div>
					</div>
				</div>
			</div>
